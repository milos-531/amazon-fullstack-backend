...
Route::get("getallorders/{user_id}",[ProductController::class,'getAllOrders']);
Route::get("getallproducts/{user_id}",[ProductController::class,'getAllProducts']);
Route::post('placeorder',[ProductController::class,'orderPlace']);
Route::post('updateorder',[ProductController::class,'updateOrder']);
